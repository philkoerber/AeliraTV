...
export function PlayerAvatar({ displayName, terrainSeed = 1337, yawRef, viewRef, moveAmountRef, useCameraYaw, serverYawRef }) {
    ...
    const idleName = useMemo(() => pickActionName(actions, ["idle", "Idle", "Survey", "Idle_001", "Armature|idle", "TPose"]), [actions]);
    const walkName = useMemo(() => pickActionName(actions, ["walk", "Walk", "run", "Run", "Walking", "Armature|walk"]), [actions]);
    ...
    return (_jsxs("group", { ref: groupRef, children: [_jsx("primitive", { object: clone }), _jsx(Html, { position: [0, normalized.headY + 0.08, 0], center: true, distanceFactor: 10, style: { pointerEvents: "none" }, children: _jsx("div", { style: {
